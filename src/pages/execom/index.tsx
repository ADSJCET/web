...
const Home = () => {
  ...
  return (
    <>
    <TextDiv>
        <AT onMouseEnter={textEnter} onMouseLeave={textLeave} className="justify-center flex" type="h1"> Meet The Dream Team </AT>
        ...
        <div className="mx-auto max-w-screen-xl flex gap-10 justify-center items-center">
          ...
          <Button variant={"secondary"} className="p-10" asChild>
            <Link href={"/execom/previous"}>
              <h4>Previous Execom </h4><ChevronRight/> 
            </Link>
          </Button>
        </div>
